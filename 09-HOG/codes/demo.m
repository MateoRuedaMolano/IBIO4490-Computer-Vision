...
test_scn_path = fullfile(data_path,'extra_test_scenes'); %CMU+MIT test scenes
...
visualize_detections_by_image_no_gt(bboxes, confidences, image_ids, test_scn_path) %label_path)
