# -*- coding: utf-8 -*-
"""
Created on Fri May  3 11:18:16 2019
...
class VOCClassSegBase(data.Dataset):
    ...
    def __init__(self, root, split='train', transform=False):
        ...
        #Cargar las imágenes y los labels
    ...
    #Pasar las imágenes a torch y hacerle el -mean y la traspuesta, label a torch
...
#Train set y val set creamos el dataloader, batch_size = 1
...
#Coger el data y el target
for data, target in train_loader: break
print(data.shape)
print(target.shape)
data.min()
#Las imágenes sin transformar
...
#fc32 WEIGHTS PRE-TRAINED MODEL
import numpy as np
import torch.nn as nn
import fcn
...
#Cargar el modelo FC16
model = FCN16s(n_class=21)
if cuda: model.to('cuda')

model
#Configurarlo para que el modelo pre-train sea FC32
cfg['fcn32s_pretrained_model'] = FCN32s.download() # Original FCN32 pretrained model

#Cargar un checkpoint o cargar los parámetros de FC32
if resume:
